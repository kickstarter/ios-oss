...
internal final class LiveStreamViewModelTests: XCTestCase {
  ...
  private let mockService = MockLiveStreamService()
  ...
  override func setUp() {
    ...
    self.vm = LiveStreamViewModel(liveStreamService: self.mockService, scheduler: self.scheduler)
  ...
  func testCreateObservers() {
    ...
    self.mockService.greenRoomOffStatus(withPath: "")
      .observe(self.greenRoomStatusOff.observer, during: lifeTime)

    self.greenRoomStatusOff.assertValues([false])
  }

  func testDoNotCreateObservers() {

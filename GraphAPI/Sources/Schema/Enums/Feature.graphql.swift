...
public enum Feature: String, EnumType {
  ...
  case seUsdCurrency2026 = "se_usd_currency_2026"
  ...
  case prelaunchUpdates = "prelaunch_updates"
  ...
  case savedSearches2026 = "saved_searches_2026"
  case batchBackerReport = "batch_backer_report"
  case enableEarlyPmLaunch = "enable_early_pm_launch"

...
public class FetchMyBackedProjectsQuery: GraphQLQuery {
  public static let operationName: String = "FetchMyBackedProjects"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query FetchMyBackedProjects($first: Int = null, $after: String = null, $withStoredCards: Boolean = false) { projects(first: $first, after: $after, backed: true, sort: END_DATE) { __typename nodes { __typename ...ProjectFragment } pageInfo { __typename hasNextPage endCursor hasPreviousPage startCursor } totalCount } }"#,
  ...
  public struct Data: GraphAPI.SelectionSet {
    ...
    public init(
      ...
      self.init(_dataDict: DataDict(
        ...
        fulfilledFragments: [
          ObjectIdentifier(FetchMyBackedProjectsQuery.Data.self)
        ]
      ))
    }
    ...
    public struct Projects: GraphAPI.SelectionSet {
      ...
      public init(
        ...
        self.init(_dataDict: DataDict(
          ...
          fulfilledFragments: [
            ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.self)
          ]
        ))
      }
      ...
      public struct Node: GraphAPI.SelectionSet {
        ...
        public init(
          ...
          self.init(_dataDict: DataDict(
            ...
            fulfilledFragments: [
              ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.self),
        ...
        public struct Category: GraphAPI.SelectionSet {
          ...
          public init(
            ...
            self.init(_dataDict: DataDict(
              ...
              fulfilledFragments: [
                ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.Category.self),
        ...
        public struct Country: GraphAPI.SelectionSet {
          ...
          public init(
            ...
            self.init(_dataDict: DataDict(
              ...
              fulfilledFragments: [
                ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.Country.self),
        ...
        public struct Creator: GraphAPI.SelectionSet {
          ...
          public init(
            ...
            self.init(_dataDict: DataDict(
              ...
              fulfilledFragments: [
                ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.Creator.self),
          ...
          public struct Location: GraphAPI.SelectionSet {
            ...
            public init(
              ...
              self.init(_dataDict: DataDict(
                ...
                fulfilledFragments: [
                  ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.Creator.Location.self),
          ...
          public struct StoredCards: GraphAPI.SelectionSet {
            ...
            public init(
              ...
              self.init(_dataDict: DataDict(
                ...
                fulfilledFragments: [
                  ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.Creator.StoredCards.self),
        ...
        public struct Goal: GraphAPI.SelectionSet {
          ...
          public init(
            ...
            self.init(_dataDict: DataDict(
              ...
              fulfilledFragments: [
                ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.Goal.self),
        ...
        public struct LastWave: GraphAPI.SelectionSet {
          ...
          public init(
            ...
            self.init(_dataDict: DataDict(
              ...
              fulfilledFragments: [
                ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.LastWave.self),
        ...
        public struct Location: GraphAPI.SelectionSet {
          ...
          public init(
            ...
            self.init(_dataDict: DataDict(
              ...
              fulfilledFragments: [
                ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.Location.self),
        ...
        public struct PledgeManager: GraphAPI.SelectionSet {
          ...
          public init(
            ...
            self.init(_dataDict: DataDict(
              ...
              fulfilledFragments: [
                ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.PledgeManager.self),
        ...
        public struct Pledged: GraphAPI.SelectionSet {
          ...
          public init(
            ...
            self.init(_dataDict: DataDict(
              ...
              fulfilledFragments: [
                ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.Node.Pledged.self),
      ...
      public struct PageInfo: GraphAPI.SelectionSet {
        ...
        public init(
          ...
          self.init(_dataDict: DataDict(
            ...
            fulfilledFragments: [
              ObjectIdentifier(FetchMyBackedProjectsQuery.Data.Projects.PageInfo.self)
            ]
          ))
        }
      }

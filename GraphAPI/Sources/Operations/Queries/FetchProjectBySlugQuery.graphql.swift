...
public class FetchProjectBySlugQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query FetchProjectBySlug($slug: String!) { me { __typename chosenCurrency } project(slug: $slug) { __typename ...ProjectFragment storyRichText { __typename ...RichTextComponentFragment } backing { __typename id } flagging { __typename id kind } } }"#,
      ...
      public struct StoryRichText: GraphAPI.SelectionSet {
        ...
        public init(
          ...
          self.init(_dataDict: DataDict(
            ...
            fulfilledFragments: [
              ObjectIdentifier(FetchProjectBySlugQuery.Data.Project.StoryRichText.self),

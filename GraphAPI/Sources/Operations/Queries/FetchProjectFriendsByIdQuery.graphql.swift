...
public class FetchProjectFriendsByIdQuery: GraphQLQuery {
  public static let operationName: String = "FetchProjectFriendsById"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query FetchProjectFriendsById($projectId: Int!, $withStoredCards: Boolean!) { project(pid: $projectId) { __typename friends { __typename nodes { __typename ...UserFragment } } } }"#,
  ...
  public struct Data: GraphAPI.SelectionSet {
    ...
    public init(
      ...
      self.init(_dataDict: DataDict(
        ...
        fulfilledFragments: [
          ObjectIdentifier(FetchProjectFriendsByIdQuery.Data.self)
        ]
      ))
    }
    ...
    public struct Project: GraphAPI.SelectionSet {
      ...
      public init(
        ...
        self.init(_dataDict: DataDict(
          ...
          fulfilledFragments: [
            ObjectIdentifier(FetchProjectFriendsByIdQuery.Data.Project.self)
          ]
        ))
      }
      ...
      public struct Friends: GraphAPI.SelectionSet {
        ...
        public init(
          ...
          self.init(_dataDict: DataDict(
            ...
            fulfilledFragments: [
              ObjectIdentifier(FetchProjectFriendsByIdQuery.Data.Project.Friends.self)
            ]
          ))
        }
        ...
        public struct Node: GraphAPI.SelectionSet {
          ...
          public init(
            ...
            self.init(_dataDict: DataDict(
              ...
              fulfilledFragments: [
                ObjectIdentifier(FetchProjectFriendsByIdQuery.Data.Project.Friends.Node.self),
          ...
          public struct Location: GraphAPI.SelectionSet {
            ...
            public init(
              ...
              self.init(_dataDict: DataDict(
                ...
                fulfilledFragments: [
                  ObjectIdentifier(FetchProjectFriendsByIdQuery.Data.Project.Friends.Node.Location.self),
          ...
          public struct StoredCards: GraphAPI.SelectionSet {
            ...
            public init(
              ...
              self.init(_dataDict: DataDict(
                ...
                fulfilledFragments: [
                  ObjectIdentifier(FetchProjectFriendsByIdQuery.Data.Project.Friends.Node.StoredCards.self),

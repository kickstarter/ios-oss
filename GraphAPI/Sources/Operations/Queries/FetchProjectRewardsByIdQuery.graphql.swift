...
public class FetchProjectRewardsByIdQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query FetchProjectRewardsById($projectId: Int!, $includeShippingRules: Boolean!, $includePledgeOverTime: Boolean!) { project(pid: $projectId) { __typename rewards { __typename nodes { __typename ...RewardFragment ...RewardImageFragment ...RewardItemsFragment ...RewardSimpleShippingRulesExpandedFragment @include(if: $includeShippingRules) } } ...PledgeOverTimeFragment @include(if: $includePledgeOverTime) } }"#,
      fragments: [LocationFragment.self, MoneyFragment.self, PledgeOverTimeFragment.self, RewardFragment.self, RewardImageFragment.self, RewardItemsFragment.self, RewardSimpleShippingRulesExpandedFragment.self, SimpleShippingRuleFragment.self]
    ))
      ...
      public struct Rewards: GraphAPI.SelectionSet {
        ...
        public struct Node: GraphAPI.SelectionSet {
          ...
          public static var __selections: [ApolloAPI.Selection] { [
            ...
            .include(if: "includeShippingRules", .inlineFragment(IfIncludeShippingRules.self)),
          ] }
          ...
          public struct Fragments: FragmentContainer {
            ...
            public var rewardSimpleShippingRulesExpandedFragment: RewardSimpleShippingRulesExpandedFragment? { _toFragment() }
          }
          ...
          ///
          /// Parent Type: `Reward`
          public struct IfIncludeShippingRules: GraphAPI.InlineFragment {
            public let __data: DataDict
            public init(_dataDict: DataDict) { __data = _dataDict }

            public typealias RootEntityType = FetchProjectRewardsByIdQuery.Data.Project.Rewards.Node
            public static var __parentType: ApolloAPI.ParentType { GraphAPI.Objects.Reward }
            public static var __selections: [ApolloAPI.Selection] { [
              .fragment(RewardSimpleShippingRulesExpandedFragment.self),
            ] }
            ...
            /// Project.Rewards.Node.IfIncludeShippingRules.SimpleShippingRulesExpanded
            ///
            ...
            public struct SimpleShippingRulesExpanded: GraphAPI.SelectionSet {
              ...
              public init(
                ...
                self.init(_dataDict: DataDict(
                  ...
                  fulfilledFragments: [
                    ObjectIdentifier(FetchProjectRewardsByIdQuery.Data.Project.Rewards.Node.IfIncludeShippingRules.SimpleShippingRulesExpanded.self),
            ...
            /// Project.Rewards.Node.IfIncludeShippingRules.Amount
            ///
            /// Parent Type: `Money`
            public struct Amount: GraphAPI.SelectionSet {
              public let __data: DataDict
              ...
              public init(
                ...
                self.init(_dataDict: DataDict(
                  ...
                  fulfilledFragments: [
                    ObjectIdentifier(FetchProjectRewardsByIdQuery.Data.Project.Rewards.Node.IfIncludeShippingRules.Amount.self),
                    ObjectIdentifier(RewardFragment.Amount.self),
                    ObjectIdentifier(MoneyFragment.self)
                  ]
                ))
            ...
            /// Project.Rewards.Node.IfIncludeShippingRules.ConvertedAmount
            ///
            /// Parent Type: `Money`
            public struct ConvertedAmount: GraphAPI.SelectionSet {
              public let __data: DataDict
              ...
              public init(
                ...
                self.init(_dataDict: DataDict(
                  ...
                  fulfilledFragments: [
                    ObjectIdentifier(FetchProjectRewardsByIdQuery.Data.Project.Rewards.Node.IfIncludeShippingRules.ConvertedAmount.self),
                    ObjectIdentifier(RewardFragment.ConvertedAmount.self),
                    ObjectIdentifier(MoneyFragment.self)
                  ]
                ))
            ...
            public struct LocalReceiptLocation: GraphAPI.SelectionSet {
              ...
              public init(
                ...
                self.init(_dataDict: DataDict(
                  ...
                  fulfilledFragments: [
                    ObjectIdentifier(FetchProjectRewardsByIdQuery.Data.Project.Rewards.Node.IfIncludeShippingRules.LocalReceiptLocation.self),
                    ObjectIdentifier(RewardFragment.LocalReceiptLocation.self),
                    ObjectIdentifier(LocationFragment.self)
                  ]
                ))
            ...
            /// Project.Rewards.Node.IfIncludeShippingRules.PledgeAmount
            ///
            /// Parent Type: `Money`
            public struct PledgeAmount: GraphAPI.SelectionSet {
              public let __data: DataDict
              ...
              public init(
                ...
                self.init(_dataDict: DataDict(
                  ...
                  fulfilledFragments: [
                    ObjectIdentifier(FetchProjectRewardsByIdQuery.Data.Project.Rewards.Node.IfIncludeShippingRules.PledgeAmount.self),
                    ObjectIdentifier(RewardFragment.PledgeAmount.self),
                    ObjectIdentifier(MoneyFragment.self)
                  ]
                ))
            ...
            /// Project.Rewards.Node.IfIncludeShippingRules.LatePledgeAmount
            ///
            /// Parent Type: `Money`
            public struct LatePledgeAmount: GraphAPI.SelectionSet {
              public let __data: DataDict
              ...
              public init(
                ...
                self.init(_dataDict: DataDict(
                  ...
                  fulfilledFragments: [
                    ObjectIdentifier(FetchProjectRewardsByIdQuery.Data.Project.Rewards.Node.IfIncludeShippingRules.LatePledgeAmount.self),
                    ObjectIdentifier(RewardFragment.LatePledgeAmount.self),
                    ObjectIdentifier(MoneyFragment.self)
                  ]
                ))

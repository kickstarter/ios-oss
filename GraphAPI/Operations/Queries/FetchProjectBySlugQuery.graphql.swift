...
public extension GraphAPI {
  class FetchProjectBySlugQuery: GraphQLQuery {
    public static let operationName: String = "FetchProjectBySlug"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query FetchProjectBySlug($slug: String!, $withStoredCards: Boolean!) { me { __typename chosenCurrency } project(slug: $slug) { __typename ...ProjectFragment backing { __typename id } flagging { __typename id kind } } }"#,

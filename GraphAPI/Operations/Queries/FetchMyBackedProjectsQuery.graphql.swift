...
public extension GraphAPI {
  class FetchMyBackedProjectsQuery: GraphQLQuery {
    ...
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        ...
        fragments: [CategoryFragment.self, CountryFragment.self, LocationFragment.self, MoneyFragment.self, ProjectFragment.self, UserFragment.self, UserStoredCardsFragment.self]
      ))

...
public extension GraphAPI {
  class FetchProjectRewardsByIdQuery: GraphQLQuery {
    public static let operationName: String = "FetchProjectRewardsById"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query FetchProjectRewardsById($projectId: Int!, $includeShippingRules: Boolean!, $includeLocalPickup: Boolean!) { project(pid: $projectId) { __typename rewards { __typename nodes { __typename ...RewardFragment simpleShippingRulesExpanded @include(if: $includeShippingRules) { __typename cost estimatedMin estimatedMax currency locationId locationName country } } } } }"#,
        fragments: [LocationFragment.self, MoneyFragment.self, RewardFragment.self, ShippingRuleFragment.self]
      ))

...
public extension GraphAPI {
  class FetchAddOnsQuery: GraphQLQuery {
    ...
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        ...
        fragments: [CategoryFragment.self, CountryFragment.self, LocationFragment.self, MoneyFragment.self, ProjectFragment.self, RewardFragment.self, ShippingRuleFragment.self, UserFragment.self, UserStoredCardsFragment.self]
      ))

...
public extension GraphAPI {
  class SearchQuery: GraphQLQuery {
    ...
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query Search($term: String, $sort: ProjectSort, $categoryId: String, $state: PublicProjectState, $raised: RaisedBuckets, $locationId: ID, $pledged: PledgedBuckets, $showRecommended: Boolean, $showSavedProjects: Boolean, $showProjectsWeLove: Boolean, $showFollowing: Boolean, $first: Int, $cursor: String) { projects( term: $term sort: $sort categoryId: $categoryId state: $state raised: $raised locationId: $locationId pledged: $pledged recommended: $showRecommended starred: $showSavedProjects following: $showFollowing staffPicks: $showProjectsWeLove after: $cursor first: $first ) { __typename nodes { __typename ...BackerDashboardProjectCellFragment ...ProjectAnalyticsFragment ...ProjectCardFragment } totalCount pageInfo { __typename endCursor hasNextPage } } }"#,

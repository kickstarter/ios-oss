...
public enum GraphAPI {
  ...
  public struct CompleteOrderInput: GraphQLMapConvertible {
    public var graphQLMap: GraphQLMap

    /// - Parameters:
    ///   - projectId: kickstarter project id
    ///   - orderId: kickstarter order id (not required for now, but will be when this is refactored)
    ///   - stripeConfirmationTokenId: the stripe confirmation token used to complete a payment (web only)
    ///   - stripePaymentMethodId: the stripe payment method id, starting with either `card_` or `pm_` (mobile only)
    ///   - paymentSourceId: Kickstarter internal payment source id. Expects a number (not the stripe id starting with `pm_`). Pass in when using a saved card (optional)
    ///   - paymentSourceReusable: If the new payment source can be reused for future payments (optional)
    ///   - paymentMethodTypes: List of accepted stripe payment method types
    ///   - clientMutationId: A unique identifier for the client performing the mutation.
    public init(projectId: GraphQLID, orderId: Swift.Optional<GraphQLID?> = nil, stripeConfirmationTokenId: Swift.Optional<String?> = nil, stripePaymentMethodId: Swift.Optional<String?> = nil, paymentSourceId: Swift.Optional<String?> = nil, paymentSourceReusable: Swift.Optional<Bool?> = nil, paymentMethodTypes: Swift.Optional<[String]?> = nil, clientMutationId: Swift.Optional<String?> = nil) {
      graphQLMap = ["projectId": projectId, "orderId": orderId, "stripeConfirmationTokenId": stripeConfirmationTokenId, "stripePaymentMethodId": stripePaymentMethodId, "paymentSourceId": paymentSourceId, "paymentSourceReusable": paymentSourceReusable, "paymentMethodTypes": paymentMethodTypes, "clientMutationId": clientMutationId]
    }
    ...
    /// kickstarter order id (not required for now, but will be when this is refactored)
    public var orderId: Swift.Optional<GraphQLID?> {
      get {
        return graphQLMap["orderId"] as? Swift.Optional<GraphQLID?> ?? Swift.Optional<GraphQLID?>.none
      }
      set {
    ...
    public var stripeConfirmationTokenId: Swift.Optional<String?> {
      get {
        return graphQLMap["stripeConfirmationTokenId"] as? Swift.Optional<String?> ?? Swift.Optional<String?>.none
      }
      set {
        graphQLMap.updateValue(newValue, forKey: "stripeConfirmationTokenId")
      }
    }

    /// the stripe payment method id, starting with either `card_` or `pm_` (mobile only)
    public var stripePaymentMethodId: Swift.Optional<String?> {
      get {
        return graphQLMap["stripePaymentMethodId"] as? Swift.Optional<String?> ?? Swift.Optional<String?>.none
      }
      set {
        graphQLMap.updateValue(newValue, forKey: "stripePaymentMethodId")
      }
    }
    ...
    public var paymentMethodTypes: Swift.Optional<[String]?> {
      get {
        return graphQLMap["paymentMethodTypes"] as? Swift.Optional<[String]?> ?? Swift.Optional<[String]?>.none
      }
      set {
        graphQLMap.updateValue(newValue, forKey: "paymentMethodTypes")
      }
    }
  ...
  public final class CompleteOrderMutation: GraphQLMutation {
    ...
    public let operationName: String = "CompleteOrder"

    public var input: CompleteOrderInput

    public init(input: CompleteOrderInput) {
      self.input = input
    }
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("completeOrder", arguments: ["input": GraphQLVariable("input")], type: .object(CompleteOrder.selections)),
        ]
      }
      ...
      public struct CompleteOrder: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["CompleteOrderPayload"]
        ...
        public init(clientMutationId: String? = nil, clientSecret: String, status: String) {
          self.init(unsafeResultMap: ["__typename": "CompleteOrderPayload", "clientMutationId": clientMutationId, "clientSecret": clientSecret, "status": status])
        }

...
public enum GraphAPI {
  ...
  public struct AddUserToSecretRewardGroupInput: GraphQLMapConvertible {
    public var graphQLMap: GraphQLMap

    /// - Parameters:
    ///   - projectId: ID of the project with secret rewards
    ///   - secretRewardToken: Secret reward token shared by the creator
    ///   - clientMutationId: A unique identifier for the client performing the mutation.
    public init(projectId: GraphQLID, secretRewardToken: String, clientMutationId: Swift.Optional<String?> = nil) {
      graphQLMap = ["projectId": projectId, "secretRewardToken": secretRewardToken, "clientMutationId": clientMutationId]
    }
    ...
    public var secretRewardToken: String {
      get {
        return graphQLMap["secretRewardToken"] as! String
      }
      set {
        graphQLMap.updateValue(newValue, forKey: "secretRewardToken")
      }
    }
  ...
  public struct BlockUserInput: GraphQLMapConvertible {
    public var graphQLMap: GraphQLMap

    /// - Parameters:
    ///   - blockUserId
    ///   - clientMutationId: A unique identifier for the client performing the mutation.
    public init(blockUserId: GraphQLID, clientMutationId: Swift.Optional<String?> = nil) {
      graphQLMap = ["blockUserId": blockUserId, "clientMutationId": clientMutationId]
    }

    public var blockUserId: GraphQLID {
      get {
        return graphQLMap["blockUserId"] as! GraphQLID
      }
      set {
        graphQLMap.updateValue(newValue, forKey: "blockUserId")
      }
    }
  ...
  public struct CreateCheckoutInput: GraphQLMapConvertible {
    ...
    ///   - refParam
    ///   - clientMutationId: A unique identifier for the client performing the mutation.
    public init(projectId: GraphQLID, amount: Swift.Optional<String?> = nil, locationId: Swift.Optional<String?> = nil, rewardIds: Swift.Optional<[GraphQLID]?> = nil, refParam: Swift.Optional<String?> = nil, clientMutationId: Swift.Optional<String?> = nil) {
      graphQLMap = ["projectId": projectId, "amount": amount, "locationId": locationId, "rewardIds": rewardIds, "refParam": refParam, "clientMutationId": clientMutationId]
    }
  ...
  public struct CreateFlaggingInput: GraphQLMapConvertible {
    public var graphQLMap: GraphQLMap
  ...
  public struct CreateOrUpdateBackingAddressInput: GraphQLMapConvertible {
    public var graphQLMap: GraphQLMap
    ...
    ///   - addressId
    ///   - clientMutationId: A unique identifier for the client performing the mutation.
    public init(backingId: GraphQLID, addressId: GraphQLID, clientMutationId: Swift.Optional<String?> = nil) {
      graphQLMap = ["backingId": backingId, "addressId": addressId, "clientMutationId": clientMutationId]
    }

    public var backingId: GraphQLID {
      get {
        return graphQLMap["backingId"] as! GraphQLID
      }
      set {
    ...
    public var addressId: GraphQLID {
      get {
        return graphQLMap["addressId"] as! GraphQLID
      }
      set {
        graphQLMap.updateValue(newValue, forKey: "addressId")
      }
    }
  ...
  public struct CreatePaymentIntentInput: GraphQLMapConvertible {
    public var graphQLMap: GraphQLMap
  ...
  public final class AddUserToSecretRewardGroupMutation: GraphQLMutation {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      mutation addUserToSecretRewardGroup($input: AddUserToSecretRewardGroupInput!) {
    ...
    public let operationName: String = "addUserToSecretRewardGroup"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("addUserToSecretRewardGroup", arguments: ["input": GraphQLVariable("input")], type: .object(AddUserToSecretRewardGroup.selections)),
        ]
      }
      ...
      public init(addUserToSecretRewardGroup: AddUserToSecretRewardGroup? = nil) {
        self.init(unsafeResultMap: ["__typename": "Mutation", "addUserToSecretRewardGroup": addUserToSecretRewardGroup.flatMap { (value: AddUserToSecretRewardGroup) -> ResultMap in value.resultMap }])
      }

      /// Adds a user to a secret reward user group
      public var addUserToSecretRewardGroup: AddUserToSecretRewardGroup? {
        get {
          return (resultMap["addUserToSecretRewardGroup"] as? ResultMap).flatMap { AddUserToSecretRewardGroup(unsafeResultMap: $0) }
        }
        set {
          resultMap.updateValue(newValue?.resultMap, forKey: "addUserToSecretRewardGroup")
        }
      }

      public struct AddUserToSecretRewardGroup: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["AddUserToSecretRewardGroupPayload"]
        ...
        public init(project: Project) {
          self.init(unsafeResultMap: ["__typename": "AddUserToSecretRewardGroupPayload", "project": project.resultMap])
        }
        ...
        public struct Project: GraphQLSelectionSet {
          ...
          public init(id: GraphQLID, rewards: Reward? = nil) {
            self.init(unsafeResultMap: ["__typename": "Project", "id": id, "rewards": rewards.flatMap { (value: Reward) -> ResultMap in value.resultMap }])
          }
          ...
          public struct Reward: GraphQLSelectionSet {
            ...
            public struct Node: GraphQLSelectionSet {
              ...
              public init(id: GraphQLID, name: String? = nil) {
                self.init(unsafeResultMap: ["__typename": "Reward", "id": id, "name": name])
              }
  ...
  public final class BlockUserMutation: GraphQLMutation {
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("blockUser", arguments: ["input": GraphQLVariable("input")], type: .object(BlockUser.selections)),
        ]
      }
      ...
      public struct BlockUser: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["BlockUserPayload"]
        ...
        public init(success: Bool) {
          self.init(unsafeResultMap: ["__typename": "BlockUserPayload", "success": success])
        }
  ...
  public final class CreateCheckoutMutation: GraphQLMutation {
    ...
    public let operationName: String = "CreateCheckout"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("createCheckout", arguments: ["input": GraphQLVariable("input")], type: .object(CreateCheckout.selections)),
        ]
      }
      ...
      public init(createCheckout: CreateCheckout? = nil) {
        self.init(unsafeResultMap: ["__typename": "Mutation", "createCheckout": createCheckout.flatMap { (value: CreateCheckout) -> ResultMap in value.resultMap }])
      }

      /// Create a backing and checkout without syncing to Rosie
      public var createCheckout: CreateCheckout? {
        get {
          return (resultMap["createCheckout"] as? ResultMap).flatMap { CreateCheckout(unsafeResultMap: $0) }
        }
        set {
          resultMap.updateValue(newValue?.resultMap, forKey: "createCheckout")
        }
      }

      public struct CreateCheckout: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["CreateCheckoutPayload"]
        ...
        public init(clientMutationId: String? = nil, checkout: Checkout? = nil) {
          self.init(unsafeResultMap: ["__typename": "CreateCheckoutPayload", "clientMutationId": clientMutationId, "checkout": checkout.flatMap { (value: Checkout) -> ResultMap in value.resultMap }])
        }
        ...
        public struct Checkout: GraphQLSelectionSet {
          ...
          public var paymentUrl: String? {
            get {
              return resultMap["paymentUrl"] as? String
            }
            set {
  ...
  public final class CreateFlaggingMutation: GraphQLMutation {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      mutation createFlagging($input: CreateFlaggingInput!) {
        createFlagging(input: $input) {
          __typename
          clientMutationId
        }
      }
    ...
    public let operationName: String = "createFlagging"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("createFlagging", arguments: ["input": GraphQLVariable("input")], type: .object(CreateFlagging.selections)),
        ]
      }
      ...
      public init(createFlagging: CreateFlagging? = nil) {
        self.init(unsafeResultMap: ["__typename": "Mutation", "createFlagging": createFlagging.flatMap { (value: CreateFlagging) -> ResultMap in value.resultMap }])
      }

      /// Create a flagging (report) of a piece flaggable content.
      public var createFlagging: CreateFlagging? {
        get {
          return (resultMap["createFlagging"] as? ResultMap).flatMap { CreateFlagging(unsafeResultMap: $0) }
        }
        set {
          resultMap.updateValue(newValue?.resultMap, forKey: "createFlagging")
        }
      }

      public struct CreateFlagging: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["CreateFlaggingPayload"]
        ...
        public init(clientMutationId: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "CreateFlaggingPayload", "clientMutationId": clientMutationId])
        }
  ...
  public final class CreateOrUpdateBackingAddressMutation: GraphQLMutation {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
    ...
    public let operationName: String = "CreateOrUpdateBackingAddress"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("createOrUpdateBackingAddress", arguments: ["input": GraphQLVariable("input")], type: .object(CreateOrUpdateBackingAddress.selections)),
        ]
      }
      ...
      public init(createOrUpdateBackingAddress: CreateOrUpdateBackingAddress? = nil) {
        self.init(unsafeResultMap: ["__typename": "Mutation", "createOrUpdateBackingAddress": createOrUpdateBackingAddress.flatMap { (value: CreateOrUpdateBackingAddress) -> ResultMap in value.resultMap }])
      }

      public var createOrUpdateBackingAddress: CreateOrUpdateBackingAddress? {
        get {
          return (resultMap["createOrUpdateBackingAddress"] as? ResultMap).flatMap { CreateOrUpdateBackingAddress(unsafeResultMap: $0) }
        }
        set {
          resultMap.updateValue(newValue?.resultMap, forKey: "createOrUpdateBackingAddress")
        }
      }

      public struct CreateOrUpdateBackingAddress: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["CreateOrUpdateBackingAddressPayload"]
        ...
        public init(success: Bool) {
          self.init(unsafeResultMap: ["__typename": "CreateOrUpdateBackingAddressPayload", "success": success])
        }
  ...
  public final class CreatePaymentIntentMutation: GraphQLMutation {
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public struct CreatePaymentIntent: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["CreatePaymentIntentPayload"]
        ...
        public init(clientSecret: String, clientMutationId: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "CreatePaymentIntentPayload", "clientSecret": clientSecret, "clientMutationId": clientMutationId])
        }
  ...
  public final class CreatePaymentSourceMutation: GraphQLMutation {
    ...
    public var queryDocument: String {
      var document: String = operationDefinition
      document.append("\n" + PaymentSourceFragment.fragmentDefinition)
      return document
    }
      ...
      public struct CreatePaymentSource: GraphQLSelectionSet {
        ...
        public struct PaymentSource: GraphQLSelectionSet {
          ...
          public static var selections: [GraphQLSelection] {
            return [
              GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
              GraphQLFragmentSpread(PaymentSourceFragment.self),
            ]
          }
          ...
          public struct Fragments {
            ...
            public var paymentSourceFragment: PaymentSourceFragment {
              get {
                return PaymentSourceFragment(unsafeResultMap: resultMap)
              }
              set {
                resultMap += newValue.resultMap
              }
  ...
  public final class FetchMyBackedProjectsQuery: GraphQLQuery {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
    ...
    public let operationName: String = "FetchMyBackedProjects"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("projects", arguments: ["first": GraphQLVariable("first"), "after": GraphQLVariable("after"), "backed": true, "sort": "END_DATE"], type: .object(Project.selections)),
        ]
      }
  ...
  public final class FetchMySavedProjectsQuery: GraphQLQuery {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
    ...
    public let operationName: String = "FetchMySavedProjects"
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("projects", arguments: ["first": GraphQLVariable("first"), "after": GraphQLVariable("after"), "starred": true, "sort": "END_DATE"], type: .object(Project.selections)),
        ]
      }
  ...
  public final class FetchProjectByIdQuery: GraphQLQuery {
    ...
    public struct Data: GraphQLSelectionSet {
      ...
      public struct Project: GraphQLSelectionSet {
        ...
        public var flagging: Flagging? {
          get {
            return (resultMap["flagging"] as? ResultMap).flatMap { Flagging(unsafeResultMap: $0) }
          }
          set {
        ...
        public struct Flagging: GraphQLSelectionSet {
          public static let possibleTypes: [String] = ["Flagging"]

          public static var selections: [GraphQLSelection] {
            return [
              GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
              GraphQLField("id", type: .nonNull(.scalar(GraphQLID.self))),
              GraphQLField("kind", type: .scalar(FlaggingKind.self)),
            ]
          }
          ...
          public init(id: GraphQLID, kind: FlaggingKind? = nil) {
            self.init(unsafeResultMap: ["__typename": "Flagging", "id": id, "kind": kind])
          }
          ...
          public var kind: FlaggingKind? {
            get {
              return resultMap["kind"] as? FlaggingKind
            }
            set {
  ...
  public final class FetchProjectRewardsByIdQuery: GraphQLQuery {
    ...
    public var queryDocument: String {
      ...
      document.append("\n" + LocationFragment.fragmentDefinition)
      document.append("\n" + ShippingRuleFragment.fragmentDefinition)
      document.append("\n" + PledgeOverTimeFragment.fragmentDefinition)
      return document
    }
    ...
    public init(projectId: Int, includeShippingRules: Bool, includeLocalPickup: Bool, includePledgeOverTime: Bool) {
      self.projectId = projectId
      self.includeShippingRules = includeShippingRules
      self.includeLocalPickup = includeLocalPickup
    ...
    public var variables: GraphQLMap? {
      return ["projectId": projectId, "includeShippingRules": includeShippingRules, "includeLocalPickup": includeLocalPickup, "includePledgeOverTime": includePledgeOverTime]
    }
      ...
      public struct Project: GraphQLSelectionSet {
        ...
        public static var selections: [GraphQLSelection] {
          return [
            GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
            GraphQLField("rewards", type: .object(Reward.selections)),
            GraphQLBooleanCondition(variableName: "includePledgeOverTime", inverted: false, selections: [
              GraphQLFragmentSpread(PledgeOverTimeFragment.self),
            ]),
          ]
        }
        ...
        public init(rewards: Reward? = nil, isPledgeOverTimeAllowed: Bool? = nil, pledgeOverTimeCollectionPlanChargeExplanation: String? = nil, pledgeOverTimeCollectionPlanChargedAsNPayments: String? = nil, pledgeOverTimeCollectionPlanShortPitch: String? = nil, pledgeOverTimeMinimumExplanation: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "Project", "rewards": rewards.flatMap { (value: Reward) -> ResultMap in value.resultMap }, "isPledgeOverTimeAllowed": isPledgeOverTimeAllowed, "pledgeOverTimeCollectionPlanChargeExplanation": pledgeOverTimeCollectionPlanChargeExplanation, "pledgeOverTimeCollectionPlanChargedAsNPayments": pledgeOverTimeCollectionPlanChargedAsNPayments, "pledgeOverTimeCollectionPlanShortPitch": pledgeOverTimeCollectionPlanShortPitch, "pledgeOverTimeMinimumExplanation": pledgeOverTimeMinimumExplanation])
        }
        ...
        public struct Fragments {
          ...
          public var pledgeOverTimeFragment: PledgeOverTimeFragment {
            get {
              return PledgeOverTimeFragment(unsafeResultMap: resultMap)
            }
            set {
              resultMap += newValue.resultMap
            }
  ...
  public final class FetchUserEmailQuery: GraphQLQuery {
    /// The raw GraphQL definition of this operation.
    public let operationDefinition: String =
      """
      query FetchUserEmail {
        me {
          __typename
          ...UserEmailFragment
        }
    ...
    public let operationName: String = "FetchUserEmail"
  ...
  public struct CommentBaseFragment: GraphQLFragment {
    /// The raw GraphQL definition of this fragment.
    public static let fragmentDefinition: String =
      """
    ...
    public static var selections: [GraphQLSelection] {
      return [
        ...
        GraphQLField("hasFlaggings", type: .nonNull(.scalar(Bool.self))),
        GraphQLField("removedPerGuidelines", type: .nonNull(.scalar(Bool.self))),
        GraphQLField("sustained", type: .nonNull(.scalar(Bool.self))),
      ]
    }
    ...
    public init(author: Author? = nil, authorBadges: [CommentBadge?]? = nil, body: String, createdAt: String? = nil, deleted: Bool, id: GraphQLID, parentId: String? = nil, hasFlaggings: Bool, removedPerGuidelines: Bool, sustained: Bool) {
      self.init(unsafeResultMap: ["__typename": "Comment", "author": author.flatMap { (value: Author) -> ResultMap in value.resultMap }, "authorBadges": authorBadges, "body": body, "createdAt": createdAt, "deleted": deleted, "id": id, "parentId": parentId, "hasFlaggings": hasFlaggings, "removedPerGuidelines": removedPerGuidelines, "sustained": sustained])
    }
    ...
    public var hasFlaggings: Bool {
      get {
        return resultMap["hasFlaggings"]! as! Bool
      }
      set {
        resultMap.updateValue(newValue, forKey: "hasFlaggings")
      }
    }
    ...
    public var removedPerGuidelines: Bool {
      get {
        return resultMap["removedPerGuidelines"]! as! Bool
      }
      set {
        resultMap.updateValue(newValue, forKey: "removedPerGuidelines")
      }
    }
    ...
    public var sustained: Bool {
      get {
        return resultMap["sustained"]! as! Bool
      }
      set {
        resultMap.updateValue(newValue, forKey: "sustained")
      }
    }
  ...
  public struct CommentFragment: GraphQLFragment {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
        GraphQLFragmentSpread(CommentBaseFragment.self),
    ...
    public struct Fragments {
      ...
      public var commentBaseFragment: CommentBaseFragment {
        get {
          return CommentBaseFragment(unsafeResultMap: resultMap)
        }
        set {
          resultMap += newValue.resultMap
        }
  ...
  public struct PaymentIncrementFragment: GraphQLFragment {
    /// The raw GraphQL definition of this fragment.
    public static let fragmentDefinition: String =
      """
  ...
  public struct PaymentSourceFragment: GraphQLFragment {
    /// The raw GraphQL definition of this fragment.
    public static let fragmentDefinition: String =
      """
  ...
  public struct PledgeOverTimeFragment: GraphQLFragment {
    /// The raw GraphQL definition of this fragment.
    public static let fragmentDefinition: String =
      """
      fragment PledgeOverTimeFragment on Project {
        __typename
  ...
  public struct PpoBackingFragment: GraphQLFragment {
    /// The raw GraphQL definition of this fragment.
    public static let fragmentDefinition: String =
      """
  ...
  public struct PpoCardFragment: GraphQLFragment {
    /// The raw GraphQL definition of this fragment.
    public static let fragmentDefinition: String =
      """
      fragment PPOCardFragment on PledgeProjectOverviewItem {
        __typename
        backing {
          __typename
          ...PPOBackingFragment
    ...
    public var tierType: String? {
      get {
        return resultMap["tierType"] as? String
      }
      set {
        resultMap.updateValue(newValue, forKey: "tierType")
      }
    }
    ...
    public struct Backing: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
          GraphQLFragmentSpread(PpoBackingFragment.self),
        ]
      }
      ...
      public struct Fragments {
        ...
        public var ppoBackingFragment: PpoBackingFragment {
          get {
            return PpoBackingFragment(unsafeResultMap: resultMap)
          }
          set {
            resultMap += newValue.resultMap
          }
  ...
  public struct PpoProjectFragment: GraphQLFragment {
    ...
    public static let fragmentDefinition: String =
      """
      fragment PPOProjectFragment on Project {
        __typename
        creator {
          __typename
          email
    ...
    public struct Creator: GraphQLSelectionSet {
      ...
      public init(email: String? = nil, id: GraphQLID, name: String) {
        self.init(unsafeResultMap: ["__typename": "User", "email": email, "id": id, "name": name])
      }
  ...
  public struct ProjectAnalyticsFragment: GraphQLFragment {
    /// The raw GraphQL definition of this fragment.
    public static let fragmentDefinition: String =
      """
    ...
    public static var selections: [GraphQLSelection] {
      return [
        ...
        GraphQLField("prelaunchActivated", alias: "isPrelaunchActivated", type: .nonNull(.scalar(Bool.self))),
        GraphQLField("tags", alias: "projectTags", arguments: ["scope": "DISCOVER"], type: .nonNull(.list(.object(ProjectTag.selections)))),
    ...
    public init(addOns: AddOn? = nil, backersCount: Int, backing: Backing? = nil, category: Category? = nil, commentsCount: Int, country: Country, creator: Creator? = nil, currency: CurrencyCode, deadlineAt: String? = nil, launchedAt: String? = nil, pid: Int, name: String, isInPostCampaignPledgingPhase: Bool, isWatched: Bool, percentFunded: Int, isPrelaunchActivated: Bool, projectTags: [ProjectTag?], postCampaignPledgingEnabled: Bool, rewards: Reward? = nil, state: ProjectState, video: Video? = nil, pledged: Pledged, fxRate: Double, usdExchangeRate: Double? = nil, posts: Post? = nil, goal: Goal? = nil) {
      self.init(unsafeResultMap: ["__typename": "Project", "addOns": addOns.flatMap { (value: AddOn) -> ResultMap in value.resultMap }, "backersCount": backersCount, "backing": backing.flatMap { (value: Backing) -> ResultMap in value.resultMap }, "category": category.flatMap { (value: Category) -> ResultMap in value.resultMap }, "commentsCount": commentsCount, "country": country.resultMap, "creator": creator.flatMap { (value: Creator) -> ResultMap in value.resultMap }, "currency": currency, "deadlineAt": deadlineAt, "launchedAt": launchedAt, "pid": pid, "name": name, "isInPostCampaignPledgingPhase": isInPostCampaignPledgingPhase, "isWatched": isWatched, "percentFunded": percentFunded, "isPrelaunchActivated": isPrelaunchActivated, "projectTags": projectTags.map { (value: ProjectTag?) -> ResultMap? in value.flatMap { (value: ProjectTag) -> ResultMap in value.resultMap } }, "postCampaignPledgingEnabled": postCampaignPledgingEnabled, "rewards": rewards.flatMap { (value: Reward) -> ResultMap in value.resultMap }, "state": state, "video": video.flatMap { (value: Video) -> ResultMap in value.resultMap }, "pledged": pledged.resultMap, "fxRate": fxRate, "usdExchangeRate": usdExchangeRate, "posts": posts.flatMap { (value: Post) -> ResultMap in value.resultMap }, "goal": goal.flatMap { (value: Goal) -> ResultMap in value.resultMap }])
    }
    ...
    /// Whether a project has activated prelaunch.
    public var isPrelaunchActivated: Bool {
      get {
        return resultMap["isPrelaunchActivated"]! as! Bool
      }
      set {
        resultMap.updateValue(newValue, forKey: "isPrelaunchActivated")
      }
    }

    /// Tags project has been tagged with
    public var projectTags: [ProjectTag?] {
      get {
        return (resultMap["projectTags"] as! [ResultMap?]).map { (value: ResultMap?) -> ProjectTag? in value.flatMap { (value: ResultMap) -> ProjectTag in ProjectTag(unsafeResultMap: value) } }
      }
      set {
        resultMap.updateValue(newValue.map { (value: ProjectTag?) -> ResultMap? in value.flatMap { (value: ProjectTag) -> ResultMap in value.resultMap } }, forKey: "projectTags")
      }
    }
    ...
    public struct AddOn: GraphQLSelectionSet {
      ...
      public init(totalCount: Int) {
        self.init(unsafeResultMap: ["__typename": "ProjectRewardConnection", "totalCount": totalCount])
      }
    ...
    public struct Category: GraphQLSelectionSet {
      ...
      public init(analyticsName: String, parentCategory: ParentCategory? = nil) {
        self.init(unsafeResultMap: ["__typename": "Category", "analyticsName": analyticsName, "parentCategory": parentCategory.flatMap { (value: ParentCategory) -> ResultMap in value.resultMap }])
      }
      ...
      public struct ParentCategory: GraphQLSelectionSet {
        ...
        public init(analyticsName: String, id: GraphQLID) {
          self.init(unsafeResultMap: ["__typename": "Category", "analyticsName": analyticsName, "id": id])
        }
    ...
    public struct Creator: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, createdProjects: CreatedProject? = nil) {
        self.init(unsafeResultMap: ["__typename": "User", "id": id, "createdProjects": createdProjects.flatMap { (value: CreatedProject) -> ResultMap in value.resultMap }])
      }
    ...
    public struct ProjectTag: GraphQLSelectionSet {
  ...
  public struct ProjectCardFragment: GraphQLFragment {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        ...
        GraphQLField("pledged", type: .nonNull(.object(Pledged.selections))),
        GraphQLFragmentSpread(ProjectAnalyticsFragment.self),
        GraphQLFragmentSpread(ProjectPamphletMainCellPropertiesFragment.self),
      ]
    }
    ...
    public struct Fragments {
      ...
      public var projectPamphletMainCellPropertiesFragment: ProjectPamphletMainCellPropertiesFragment {
        get {
          return ProjectPamphletMainCellPropertiesFragment(unsafeResultMap: resultMap)
        }
        set {
          resultMap += newValue.resultMap
        }
  ...
  public struct ProjectPamphletMainCellPropertiesFragment: GraphQLFragment {
    /// The raw GraphQL definition of this fragment.
    public static let fragmentDefinition: String =
      """
    ...
    public static var selections: [GraphQLSelection] {
      return [
        ...
        GraphQLField("pid", type: .nonNull(.scalar(Int.self))),
        GraphQLField("name", type: .nonNull(.scalar(String.self))),
        GraphQLField("description", alias: "projectDescription", type: .nonNull(.scalar(String.self))),
        GraphQLField("creator", type: .object(Creator.selections)),
        GraphQLField("state", type: .nonNull(.scalar(ProjectState.self))),
        GraphQLField("stateChangedAt", type: .nonNull(.scalar(String.self))),
        GraphQLField("image", type: .object(Image.selections)),
        ...
        GraphQLField("fxRate", type: .nonNull(.scalar(Double.self))),
        GraphQLField("usdExchangeRate", type: .scalar(Double.self)),
        GraphQLField("projectUsdExchangeRate", type: .nonNull(.scalar(Double.self))),
        GraphQLField("category", type: .object(Category.selections)),
        GraphQLField("location", type: .object(Location.selections)),
        GraphQLField("deadlineAt", type: .scalar(String.self)),
        GraphQLField("launchedAt", type: .scalar(String.self)),
    ...
    public var projectDescription: String {
      get {
        return resultMap["projectDescription"]! as! String
      }
      set {
        resultMap.updateValue(newValue, forKey: "projectDescription")
      }
    }
    ...
    public var projectUsdExchangeRate: Double {
      get {
        return resultMap["projectUsdExchangeRate"]! as! Double
      }
      set {
        resultMap.updateValue(newValue, forKey: "projectUsdExchangeRate")
      }
    }
    ...
    public struct Creator: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, name: String, isBlocked: Bool? = nil, imageUrl: String) {
        self.init(unsafeResultMap: ["__typename": "User", "id": id, "name": name, "isBlocked": isBlocked, "imageUrl": imageUrl])
      }
    ...
    public struct Image: GraphQLSelectionSet {
      ...
      public init(url: String) {
        self.init(unsafeResultMap: ["__typename": "Photo", "url": url])
      }
    ...
    public struct Location: GraphQLSelectionSet {
      ...
      public init(displayableName: String) {
        self.init(unsafeResultMap: ["__typename": "Location", "displayableName": displayableName])
      }
    ...
    public struct Video: GraphQLSelectionSet {
      ...
      public init(videoSources: VideoSource? = nil) {
        self.init(unsafeResultMap: ["__typename": "Video", "videoSources": videoSources.flatMap { (value: VideoSource) -> ResultMap in value.resultMap }])
      }
      ...
      public struct VideoSource: GraphQLSelectionSet {
        ...
        public init(hls: Hl? = nil, high: High? = nil) {
          self.init(unsafeResultMap: ["__typename": "VideoSources", "hls": hls.flatMap { (value: Hl) -> ResultMap in value.resultMap }, "high": high.flatMap { (value: High) -> ResultMap in value.resultMap }])
        }
  ...
  public struct RewardFragment: GraphQLFragment {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        ...
        GraphQLField("name", type: .scalar(String.self)),
        GraphQLField("pledgeAmount", type: .nonNull(.object(PledgeAmount.selections))),
        GraphQLField("latePledgeAmount", type: .nonNull(.object(LatePledgeAmount.selections))),
        GraphQLField("postCampaignPledgingEnabled", type: .nonNull(.scalar(Bool.self))),
        GraphQLField("project", type: .object(Project.selections)),
    ...
    public var pledgeAmount: PledgeAmount {
      get {
        return PledgeAmount(unsafeResultMap: resultMap["pledgeAmount"]! as! ResultMap)
      }
      set {
        resultMap.updateValue(newValue.resultMap, forKey: "pledgeAmount")
      }
    }

    /// Amount for claiming this reward after the campaign.
    public var latePledgeAmount: LatePledgeAmount {
      get {
        return LatePledgeAmount(unsafeResultMap: resultMap["latePledgeAmount"]! as! ResultMap)
      }
      set {
        resultMap.updateValue(newValue.resultMap, forKey: "latePledgeAmount")
      }
    }
    ...
    public struct PledgeAmount: GraphQLSelectionSet {
      public static let possibleTypes: [String] = ["Money"]
    ...
    public struct LatePledgeAmount: GraphQLSelectionSet {
      public static let possibleTypes: [String] = ["Money"]
  ...
  public struct UserSettingsFragment: GraphQLFragment {
    /// The raw GraphQL definition of this fragment.
    public static let fragmentDefinition: String =
      """

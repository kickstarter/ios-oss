...
extension Backing {
  public enum lens {
    ...
    public static let id = Lens<Backing, Int>(
      view: { $0.id },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed, id: $0,
        locationId: $1.locationId, pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry,
        projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence,
        shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let locationId = Lens<Backing, Int?>(
      view: { $0.locationId },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed, id: $1.id, locationId: $0,
    ...
    public static let pledgedAt = Lens<Backing, TimeInterval>(
      view: { $0.pledgedAt },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed, id: $1.id,

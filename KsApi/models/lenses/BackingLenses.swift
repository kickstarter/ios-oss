...
extension Backing {
  public enum lens {
    public static let amount = Lens<Backing, Int>(
      view: { $0.amount },
      set: { Backing(amount: $0, backer: $1.backer, backerId: $1.backerId, completed: $1.completed, backerCompleted: $1.backerCompleted, id: $1.id,
    ...
    public static let backer = Lens<Backing, User?>(
      view: { $0.backer },
      set: { Backing(amount: $1.amount, backer: $0, backerId: $1.backerId, completed: $1.completed, backerCompleted: $1.backerCompleted, id: $1.id,
        locationId: $1.locationId, pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry,
        projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence,
        shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let backerId = Lens<Backing, Int>(
      view: { $0.backerId },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $0, completed: $1.completed, backerCompleted: $1.backerCompleted, id: $1.id,
        locationId: $1.locationId, pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry,
        projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence,
        shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let completed = Lens<Backing, Bool?>(
      view: { $0.completed },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $0, backerCompleted: $1.backerCompleted, id: $1.id,
        locationId: $1.locationId, pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry,
        projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence,
        shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let backerCompleted = Lens<Backing, Bool?>(
      ...
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed, backerCompleted: $0, id: $1.id,
                     locationId: $1.locationId, pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry,
                     projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence,
                     shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let id = Lens<Backing, Int>(
      view: { $0.id },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed, backerCompleted: $1.backerCompleted,
        id: $0, locationId: $1.locationId, pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry,
        projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence,
        shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let locationId = Lens<Backing, Int?>(
      view: { $0.locationId },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed, backerCompleted: $1.backerCompleted,
        id: $1.id, locationId: $0, pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry,
        projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence,
        shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let pledgedAt = Lens<Backing, TimeInterval>(
      view: { $0.pledgedAt },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed, backerCompleted: $1.backerCompleted,
        id: $1.id, locationId: $1.locationId, pledgedAt: $0, projectCountry: $1.projectCountry,
        projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence,
        shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let projectCountry = Lens<Backing, String>(
      ...
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed, backerCompleted: $1.backerCompleted,
        id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt, projectCountry: $0,
        projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence,
        shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let projectId = Lens<Backing, Int>(
      view: { $0.projectId },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed, backerCompleted: $1.backerCompleted,
        id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt, projectCountry: $1.projectCountry,
        projectId: $0, reward: $1.reward, rewardId: $1.rewardId, sequence: $1.sequence,
        shippingAmount: $1.shippingAmount, status: $1.status) }
    )

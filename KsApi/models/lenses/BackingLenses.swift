...
extension Backing {
  public enum lens {
    public static let amount = Lens<Backing, Int>(
      view: { $0.amount },
      set: { Backing(amount: $0, backer: $1.backer, backerId: $1.backerId, completed: $1.completed,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
    ...
    public static let backer = Lens<Backing, User?>(
      view: { $0.backer },
      set: { Backing(amount: $1.amount, backer: $0, backerId: $1.backerId, completed: $1.completed,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
        projectCountry: $1.projectCountry, projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId,
        sequence: $1.sequence, shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let backerId = Lens<Backing, Int>(
      view: { $0.backerId },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $0, completed: $1.completed,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
        projectCountry: $1.projectCountry, projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId,
        sequence: $1.sequence, shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let completed = Lens<Backing, Bool?>(
      view: { $0.completed },
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $0,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
        projectCountry: $1.projectCountry, projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId,
        sequence: $1.sequence, shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let backerCompleted = Lens<Backing, Bool?>(
      ...
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed,
    ...
    public static let projectCountry = Lens<Backing, String>(
      ...
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
        projectCountry: $0, projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId,
        sequence: $1.sequence, shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let projectId = Lens<Backing, Int>(
      ...
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
        projectCountry: $1.projectCountry, projectId: $0, reward: $1.reward, rewardId: $1.rewardId,
        sequence: $1.sequence, shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let reward = Lens<Backing, Reward?>(
      ...
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
        projectCountry: $1.projectCountry, projectId: $1.projectId, reward: $0, rewardId: $1.rewardId,
        sequence: $1.sequence, shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let rewardId = Lens<Backing, Int?>(
      ...
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
        projectCountry: $1.projectCountry, projectId: $1.projectId, reward: $1.reward, rewardId: $0,
        sequence: $1.sequence, shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let sequence = Lens<Backing, Int>(
      ...
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
        projectCountry: $1.projectCountry, projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId,
        sequence: $0, shippingAmount: $1.shippingAmount, status: $1.status) }
    )
    ...
    public static let shippingAmount = Lens<Backing, Int?>(
      ...
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
        projectCountry: $1.projectCountry, projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId,
        sequence: $1.sequence, shippingAmount: $0, status: $1.status) }
    )
    ...
    public static let status = Lens<Backing, Status>(
      ...
      set: { Backing(amount: $1.amount, backer: $1.backer, backerId: $1.backerId, completed: $1.completed,
        backerCompleted: $1.backerCompleted, id: $1.id, locationId: $1.locationId, pledgedAt: $1.pledgedAt,
        projectCountry: $1.projectCountry, projectId: $1.projectId, reward: $1.reward, rewardId: $1.rewardId,
        sequence: $1.sequence, shippingAmount: $1.shippingAmount, status: $0) }
    )
  }
}

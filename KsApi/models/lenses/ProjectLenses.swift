...
extension Project {
  public enum lens {
    public static let blurb = Lens<Project, String>(
      view: { $0.blurb },
      set: { Project(blurb: $0, staffPick: $1.staffPick, category: $1.category, country: $1.country,
    ...
    public static let category = Lens<Project, Category>(
      view: { $0.category },
      set: { Project(blurb: $1.blurb, staffPick: $1.staffPick, category: $0, country: $1.country,
        creator: $1.creator, memberData: $1.memberData, dates: $1.dates, id: $1.id,
        location: $1.location, name: $1.name, personalization: $1.personalization, photo: $1.photo,
        rewards: $1.rewards, slug: $1.slug, state: $1.state, stats: $1.stats, urls: $1.urls,
        video: $1.video) }
    ...
    public static let country = Lens<Project, Country>(
      view: { $0.country },
      set: { Project(blurb: $1.blurb, staffPick: $1.staffPick, category: $1.category, country: $0,
        creator: $1.creator, memberData: $1.memberData, dates: $1.dates, id: $1.id,
        location: $1.location, name: $1.name, personalization: $1.personalization, photo: $1.photo,
        rewards: $1.rewards, slug: $1.slug, state: $1.state, stats: $1.stats, urls: $1.urls,
        video: $1.video) }
    ...
    public static let creator = Lens<Project, User>(
      view: { $0.creator },
      set: { Project(blurb: $1.blurb, staffPick: $1.staffPick, category: $1.category, country: $1.country,

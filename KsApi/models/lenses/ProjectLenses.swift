  ...
  public enum lens {
    public static let blurb = Lens<Project, String>(
      ...
      set: { Project(blurb: $0, category: $1.category, country: $1.country,
        ...
        rewards: $1.rewards, slug: $1.slug, staffPick: $1.staffPick, state: $1.state, stats: $1.stats, urls: $1.urls,
        video: $1.video) }
    )
    ...
    public static let staffPick = Lens<Project, Bool>(
      ...
      set: { Project(blurb: $1.blurb, category: $1.category, country: $1.country,
                     ...
                     photo: $1.photo, rewards: $1.rewards, slug: $1.slug, staffPick: $0, state: $1.state, stats: $1.stats,
    ...
    public static let personalization = Lens<Project, Project.Personalization>(
      ...
      set: { Project(blurb: $1.blurb, category: $1.category, country: $1.country,
        ...
        slug: $1.slug, staffPick: $1.staffPick, state: $1.state, stats: $1.stats, urls: $1.urls, video: $1.video) }
    )
    ...
    public static let rewards = Lens<Project, [Reward]>(
      ...
      set: { Project(blurb: $1.blurb, category: $1.category, country: $1.country,
        creator: $1.creator, memberData: $1.memberData, dates: $1.dates, id: $1.id,
        location: $1.location, name: $1.name, personalization: $1.personalization, photo: $1.photo,
        rewards: $0, slug: $1.slug, staffPick: $1.staffPick, state: $1.state, stats: $1.stats, urls: $1.urls, video: $1.video) }
    )
    ...
    public static let slug = Lens<Project, String>(
      ...
      set: { Project(blurb: $1.blurb, category: $1.category, country: $1.country,
        creator: $1.creator, memberData: $1.memberData, dates: $1.dates, id: $1.id,
        location: $1.location, name: $1.name, personalization: $1.personalization, photo: $1.photo,
        rewards: $1.rewards, slug: $0, staffPick: $1.staffPick, state: $1.state, stats: $1.stats, urls: $1.urls, video: $1.video) }
    )
    ...
    public static let state = Lens<Project, Project.State>(
      ...
      set: { Project(blurb: $1.blurb, category: $1.category, country: $1.country,
        creator: $1.creator, memberData: $1.memberData, dates: $1.dates, id: $1.id,
        location: $1.location, name: $1.name, personalization: $1.personalization, photo: $1.photo,
        rewards: $1.rewards, slug: $1.slug, staffPick: $1.staffPick, state: $0, stats: $1.stats, urls: $1.urls, video: $1.video) }
    )
    ...
    public static let stats = Lens<Project, Project.Stats>(
      ...
      set: { Project(blurb: $1.blurb, category: $1.category, country: $1.country,
        creator: $1.creator, memberData: $1.memberData, dates: $1.dates, id: $1.id,
        location: $1.location, name: $1.name, personalization: $1.personalization, photo: $1.photo,
        rewards: $1.rewards, slug: $1.slug, staffPick: $1.staffPick, state: $1.state, stats: $0, urls: $1.urls, video: $1.video) }
    )
    ...
    public static let urls = Lens<Project, Project.UrlsEnvelope>(
      ...
      set: { Project(blurb: $1.blurb, category: $1.category, country: $1.country,
        creator: $1.creator, memberData: $1.memberData, dates: $1.dates, id: $1.id,
        location: $1.location, name: $1.name, personalization: $1.personalization, photo: $1.photo,
        rewards: $1.rewards, slug: $1.slug, staffPick: $1.staffPick, state: $1.state, stats: $1.stats, urls: $0, video: $1.video) }
    )
    ...
    public static let video = Lens<Project, Project.Video?>(
      ...
      set: { Project(blurb: $1.blurb, category: $1.category, country: $1.country,
        creator: $1.creator, memberData: $1.memberData, dates: $1.dates, id: $1.id,
        location: $1.location, name: $1.name, personalization: $1.personalization, photo: $1.photo,
        rewards: $1.rewards, slug: $1.slug, staffPick: $1.staffPick, state: $1.state, stats: $1.stats, urls: $1.urls, video: $0) }
    )
  }
}

  ...
  extension User {
    public enum lens {
      public static let avatar = Lens<User, User.Avatar>(
        view: { $0.avatar },
        set: { User(avatar: $0, facebookConnected: $1.facebookConnected, generateRecommendations: $1.generateRecommendations, id: $1.id, isFriend: $1.isFriend,
      ...
      public static let facebookConnected = Lens<User, Bool?>(
        ...
        set: { User(avatar: $1.avatar, facebookConnected: $0, generateRecommendations:$1.generateRecommendations, id: $1.id, isFriend: $1.isFriend,
          liveAuthToken: $1.liveAuthToken, location: $1.location, name: $1.name, newsletters: $1.newsletters,
          notifications: $1.notifications, social: $1.social, stats: $1.stats) }
      )

      public static let generateRecommendations = Lens<User, Bool?>(
        view: { $0.generateRecommendations },
        set: { User(avatar: $1.avatar, facebookConnected: $1.facebookConnected, generateRecommendations: $0, id: $1.id, isFriend: $1.isFriend,
          liveAuthToken: $1.liveAuthToken, location: $1.location, name: $1.name, newsletters: $1.newsletters,
          notifications: $1.notifications, social: $1.social, stats: $1.stats) }
      )
      ...
      public static let id = Lens<User, Int>(
        view: { $0.id },
        set: { User(avatar: $1.avatar, facebookConnected: $1.facebookConnected, generateRecommendations:$1.generateRecommendations, id: $0, isFriend: $1.isFriend,
          liveAuthToken: $1.liveAuthToken, location: $1.location, name: $1.name, newsletters: $1.newsletters,
          notifications: $1.notifications, social: $1.social, stats: $1.stats) }
      )
      ...
      public static let isFriend = Lens<User, Bool?>(
        view: { $0.isFriend },
        set: { User(avatar: $1.avatar, facebookConnected: $1.facebookConnected, generateRecommendations:$1.generateRecommendations, id: $1.id, isFriend: $0,
          liveAuthToken: $1.liveAuthToken, location: $1.location, name: $1.name, newsletters: $1.newsletters,
          notifications: $1.notifications, social: $1.social, stats: $1.stats) }
      )
      ...
      public static let liveAuthToken = Lens<User, String?>(
        ...
        set: { User(avatar: $1.avatar, facebookConnected: $1.facebookConnected, generateRecommendations:$1.generateRecommendations, id: $1.id,

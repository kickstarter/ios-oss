...
public struct DemoComment: Codable {
  ...
  public let postTime, body: String
  public let userTag: UserTagEnum
  ...
  public enum UserTagEnum: String, Codable {
    case backer
    case superbacker
    case creator
    case you
  ...
  public static func comments() -> [DemoComment] {

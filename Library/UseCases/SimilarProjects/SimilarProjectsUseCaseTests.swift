...
final class SimilarProjectsUseCaseTests: TestCase {
  ...
  private func createMockProjectNode(
    ...
    creatorName _: String = "Test Creator",
    creatorAvatarURL _: String = "https://example.com/avatar.jpg",
    creatorId _: Int = 987,
    isCreatorBlocked _: Bool = false,
    stateChangedAt: String = "1741737000",
    backersCount: Int = 150,
    categoryName _: String = "Test Category",
    locationName _: String = "Test Location",
    fxRate: Float = 1.0,
    usdExchangeRate _: Float = 1.0,
    projectUsdExchangeRate: Float = 1.0,
    convertedPledgedAmount _: Float? = 7_500.0,
    currency: String = "USD",
    currentCurrencyCode _: String? = "USD",

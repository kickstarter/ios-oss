...
public protocol SimilarProjectsUseCaseInputs {
  ...
  func projectTapped(project: any ProjectCardProperties)
...
public protocol SimilarProjectsUseCaseOutputs {
  ...
  var navigateToProject: Signal<any ProjectCardProperties, Never> { get }
}
...
public final class SimilarProjectsUseCase: SimilarProjectsUseCaseType, SimilarProjectsUseCaseInputs,
  ...
  private let (projectTappedSignal, projectTappedObserver) = Signal<any ProjectCardProperties, Never>.pipe()
  public func projectTapped(project: any ProjectCardProperties) {
  ...
  public let navigateToProject: Signal<any ProjectCardProperties, Never>

...
public protocol PledgeViewRoutingUseCaseInputs {
  func goToPledgeViewTapped()
}

public protocol PledgeViewRoutingUseCaseOutputs {
...
public protocol ManagePledgeViewRoutingUseCaseType {
  var inputs: PledgeViewRoutingUseCaseInputs { get }
  var outputs: PledgeViewRoutingUseCaseOutputs { get }
}
...
public final class PledgeViewRoutingUseCase: ManagePledgeViewRoutingUseCaseType,
  PledgeViewRoutingUseCaseInputs,
  PledgeViewRoutingUseCaseOutputs {
  ...
  public var inputs: PledgeViewRoutingUseCaseInputs { return self }
  public var outputs: PledgeViewRoutingUseCaseOutputs { return self }

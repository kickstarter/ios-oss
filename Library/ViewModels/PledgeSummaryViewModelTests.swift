...
internal final class PledgeSummaryViewModelTests: TestCase {
  ...
  func testAmountAttributedText_US_ProjectCurrency_RegularReward() {
    ...
    self.vm.inputs.configure(with: (project, total: 30, false), pledgeHasNoReward: false)
  ...
  func testAmountAttributedText_US_ProjectCurrency_NoReward() {
    let project = Project.template
      |> Project.lens.stats.currency .~ Project.Country.us.currencyCode
      |> Project.lens.country .~ Project.Country.us
    self.vm.inputs.configure(with: (project, total: 10, false), pledgeHasNoReward: true)
  ...
  func testAmountAttributedText_NonUS_ProjectCurrency_NoReward() {
    ...
    self.vm.inputs.configure(with: pledgeSummaryViewData, pledgeHasNoReward: true)
  ...
  func testTotalConversionText_NeedsConversion_RegularReward() {
    ...
    self.vm.inputs.configure(with: (project, total: 20, false), pledgeHasNoReward: false)
    self.vm.inputs.viewDidLoad()
  ...
  func testTotalConversionText_NoConversionNeeded() {
    ...
    self.vm.inputs.configure(with: (project, total: 10, false), pledgeHasNoReward: false)
    self.vm.inputs.viewDidLoad()
  ...
  func testUpdateContext_ConfirmationLabel() {
    ...
    withEnvironment(calendar: calendar, locale: Locale(identifier: "en")) {
      ...
      self.vm.inputs.configure(with: (project: project, total: 10, false), pledgeHasNoReward: false)
      self.vm.inputs.viewDidLoad()
  ...
  func testUpdateContext_ConfirmationLabel_Hidden() {
    ...
    withEnvironment(calendar: calendar, locale: Locale(identifier: "en")) {
      ...
      self.vm.inputs.configure(with: (project: project, total: 10, true), pledgeHasNoReward: false)
      self.vm.inputs.viewDidLoad()

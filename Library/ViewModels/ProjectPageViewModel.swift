...
public protocol ProjectPageViewModelInputs {
  ...
  func similarProjectTapped(project: any ProjectCardProperties)
}
...
public protocol ProjectPageViewModelOutputs {
  ...
  var navigateToSimilarProject: Signal<any ProjectCardProperties, Never> { get }
}
...
public final class ProjectPageViewModel: ProjectPageViewModelType, ProjectPageViewModelInputs,
  ...
  public func similarProjectTapped(project: any ProjectCardProperties) {
  ...
  public var navigateToSimilarProject: Signal<any ProjectCardProperties, Never> {

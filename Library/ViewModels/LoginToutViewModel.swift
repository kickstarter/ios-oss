...
public protocol LoginToutViewModelErrors {
...
LoginToutViewModelOutputs, LoginToutViewModelErrors {
  ...
  public var errors: LoginToutViewModelErrors { return self }
  ...
  // MARK: Errors
  public let showFacebookError: Signal<(title: String, message: String), NoError>

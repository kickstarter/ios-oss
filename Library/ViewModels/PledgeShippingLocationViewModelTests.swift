...
final class PledgeShippingLocationViewModelTests: TestCase {
  ...
  func testDefaultShippingRule_ProjectCountryEqualsProjectCurrencyCountry_US() {
    let mockService = MockService(fetchGraphQLResponses: [
      (ShippableLocationsQuery.self, shippingLocationsData)
    ])
  ...
  func testShippingRulesError_ProjectCountryEqualsProjectCurrencyCountry_US() {
    let errorData = GraphAPI.ShippableLocationsQuery.Data(
      shippingCountryLocations: []
    )

    let mockService = MockService(fetchGraphQLResponses: [
      (ShippableLocationsQuery.self, errorData)
    ])
  ...
  func testShippingLocationFromBackingIsDefault_ProjectCountryEqualsProjectCurrencyCountry_US_NewRewardDoesNotHaveSelectedRule(
    ...
    let shippingDataWithoutCanada = GraphAPI.ShippableLocationsQuery.Data(
      shippingCountryLocations: [
        GraphAPI.ShippableLocationsQuery.Data.ShippingCountryLocation(
          country: "US",
...
private let shippingLocationsData = GraphAPI.ShippableLocationsQuery.Data(
  shippingCountryLocations: [
    GraphAPI.ShippableLocationsQuery.Data.ShippingCountryLocation(
      country: "US",
      countryName: "United States",

...
internal final class HelpViewModelTests: TestCase {
  ...
  func testHelpFlow() {
    ...
    XCTAssertEqual(
      ["Selected Help Option", "Selected Help Option", "Selected Help Option"],
    ...
    XCTAssertEqual(
      ["Cookie Policy", "FAQ", "How It Works"],
    ...
    XCTAssertEqual(
      ["Cookie Policy", "FAQ", "How It Works", "Privacy Policy"],
      self.trackingClient.properties.map { $0["type"] as! String? }
    )
    ...
    XCTAssertEqual([
      "Selected Help Option", "Selected Help Option", "Selected Help Option",
      "Selected Help Option", "Selected Help Option"
    ], self.trackingClient.events)
    XCTAssertEqual(
    ...
    XCTAssertEqual(
      ["Cookie Policy", "FAQ", "How It Works", "Privacy Policy", "Terms"],
      self.trackingClient.properties.map { $0["type"] as! String? }
    )
  }
  ...
  func testFlow_Contact() {
    ...
    XCTAssertEqual(
      ["Contact Email Open", "Selected Help Option", "Sent Contact Email", "Contact Email Sent"],
      self.trackingClient.events
    )
    XCTAssertEqual(
      [nil, "Settings", "Settings", nil],
      self.trackingClient.properties.map { $0["context"] as! String? }
    )
    ...
    XCTAssertEqual([
      "Contact Email Open", "Selected Help Option", "Sent Contact Email",
      "Contact Email Sent", "Contact Email Open", "Selected Help Option"
    ], self.trackingClient.events)
    XCTAssertEqual(
      [nil, "Settings", "Settings", nil, nil, "Settings"],
      self.trackingClient.properties.map { $0["context"] as! String? }
    )
    XCTAssertEqual(
      [nil, "Contact", nil, nil, nil, "Contact"],
      self.trackingClient.properties.map { $0["type"] as! String? }
    )
    ...
    XCTAssertEqual(
      [nil, "Settings", "Settings", nil, nil, "Settings", "Settings"],
      self.trackingClient.properties.map { $0["context"] as! String? }
    )
    XCTAssertEqual(
      [nil, "Contact", nil, nil, nil, "Contact", nil],
      self.trackingClient.properties.map { $0["type"] as! String? }
    )
    ...
    XCTAssertEqual(
      [nil, "Settings", "Settings", nil, nil, "Settings", "Settings", "Settings"],
      self.trackingClient.properties.map { $0["context"] as! String? }
    )
    XCTAssertEqual(
      [nil, "Contact", nil, nil, nil, "Contact", nil, "Contact"],
      self.trackingClient.properties.map { $0["type"] as! String? }
    )
  }

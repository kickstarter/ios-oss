...
再度お試しください。"
  ...
  */
  ...
  /**
   ...
   - **fr**: "Pour sélectionner cette récompense, vous devez vous engager à hauteur de %{reward_minimum}."
   - **ja**: "You need to pledge at least %{reward_minimum} for this reward."
  */

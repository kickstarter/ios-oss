...
with friends."
  ...
  */
  ...
  /**
   ...
   - **de**: "More than %{number_of_items} items"
   - **es**: "More than %{number_of_items} items"
   - **fr**: "More than %{number_of_items} items"
   - **ja**: "More than %{number_of_items} items"
  */
...
iOSの場合、設定からFacebookのアクセスを許可してください。"
  ...
  */
  ...
  /**
   ...
   - **de**: "%{number_of_items} items"
   - **es**: "%{number_of_items} items"
   - **fr**: "%{number_of_items} items"
   - **ja**: "%{number_of_items} items"
  */

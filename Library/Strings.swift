...
再度お試しください。"
  ...
  */
  ...
  /**
   ...
   - **de**: "You need to pledge at least %{reward_minimum} for this reward."
   - **es**: "You need to pledge at least %{reward_minimum} for this reward."
   - **fr**: "You need to pledge at least %{reward_minimum} for this reward."

...
public final class RefTagTests: XCTestCase {
  ...
  func testInit() {
    ...
    XCTAssertEqual(RefTag.categoryWithSort(.EndingSoon), RefTag(code: RefTag.categoryWithSort(.EndingSoon).stringTag))
    XCTAssertEqual(RefTag.category, RefTag(code: RefTag.categoryWithSort(.Magic).stringTag))
    XCTAssertEqual(RefTag.categoryWithSort(.MostFunded), RefTag(code: RefTag.categoryWithSort(.MostFunded).stringTag))
    XCTAssertEqual(RefTag.categoryWithSort(.Newest), RefTag(code: RefTag.categoryWithSort(.Newest).stringTag))
    XCTAssertEqual(RefTag.categoryWithSort(.Popular), RefTag(code: RefTag.categoryWithSort(.Popular).stringTag))
    ...
    XCTAssertEqual(RefTag.recommendedWithSort(.EndingSoon), RefTag(code: RefTag.recommendedWithSort(.EndingSoon).stringTag))
    XCTAssertEqual(RefTag.recommendedWithSort(.MostFunded), RefTag(code: RefTag.recommendedWithSort(.MostFunded).stringTag))
    XCTAssertEqual(RefTag.recommendedWithSort(.Newest), RefTag(code: RefTag.recommendedWithSort(.Newest).stringTag))
    XCTAssertEqual(RefTag.recommendedWithSort(.Popular), RefTag(code: RefTag.recommendedWithSort(.Popular).stringTag))

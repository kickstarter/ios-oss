...
internal final class ProfileProjectCellViewModelTests: TestCase {
  ...
  func testProjectProgressUI() {
    ...
    self.stateBackgroundColor.assertValues([.ksr_darkGray], "Default background color is gray.")
  ...
  func testProjectFailedBanner() {
    ...
    self.stateBackgroundColor.assertValues([.ksr_darkGray])
  ...
  func testProjectSuccessfulBanner() {
    ...
    self.stateBackgroundColor.assertValues([.ksr_green(weight: 400)])
    self.stateHidden.assertValues([false])
  }

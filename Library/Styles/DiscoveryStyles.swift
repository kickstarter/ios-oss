...
public let discoveryOnboardingLogoStyle =
  UIImageView.lens.contentMode .~ .scaleAspectFit
    <> UIImageView.lens.contentHuggingPriority(for: .vertical) .~ UILayoutPriorityRequired
    <> UIImageView.lens.contentCompressionResistancePriority(for: .vertical) .~ UILayoutPriorityRequired

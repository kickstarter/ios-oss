...
public func == (lhs: RefTag, rhs: RefTag) -> Bool {
  ...
  case (.activity, .activity), (.category, .category), (.categoryFeatured, .categoryFeatured),
    ...
    (.recommended, .recommended), (.search, .search), (.searchFeatured, .searchFeatured), (.searchPopular, .searchPopular), (.searchPopularFeatured, .searchPopularFeatured), (.social, .social), (.thanks, .thanks),
    (.update, .update):
    return true

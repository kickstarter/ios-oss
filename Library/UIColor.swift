...
extension UIColor {
  @nonobjc static func hexa(value: UInt32) -> UIColor {
    ...
    let aRounded = UIColor.toDecimalPlace(a, 1)
    let rRounded = UIColor.toDecimalPlace(r, 2)
    let gRounded = UIColor.toDecimalPlace(g, 2)
    let bRounded = UIColor.toDecimalPlace(b, 2)
  ...
  private static func toDecimalPlace(num: CGFloat, _ decimalNum: Int) -> CGFloat {
    switch decimalNum {
    case 1:

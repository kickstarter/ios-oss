...
final class KSRAnalyticsTests: TestCase {
  ...
  func testProjectProperties() {
    ...
    XCTAssertEqual(1_560.0, dataLakeClientProperties?["project_current_amount_pledged_usd"] as? Decimal)
    XCTAssertEqual(3_120.0, dataLakeClientProperties?["project_goal_usd"] as? Decimal)
    ...
    XCTAssertEqual(1_560.0, segmentClientProperties?["project_current_amount_pledged_usd"] as? Decimal)
    XCTAssertEqual(3_120.00, segmentClientProperties?["project_goal_usd"] as? Decimal)
  ...
  private func assertProjectProperties(
    ...
    XCTAssertEqual(1_560.00, props?["project_current_amount_pledged_usd"] as? Decimal)
    XCTAssertEqual(3_120.00, props?["project_goal_usd"] as? Decimal)

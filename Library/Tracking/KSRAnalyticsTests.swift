...
final class KSRAnalyticsTests: TestCase {
  ...
  func testProjectProperties() {
    ...
    XCTAssertEqual(2_000, dataLakeClientProperties?["project_current_amount_pledged_usd"] as? Double)
    ...
    XCTAssertEqual(2_000, segmentClientProperties?["project_current_amount_pledged_usd"] as? Double)
  ...
  private func assertProjectProperties(
    ...
    XCTAssertEqual(2_000, props?["project_current_amount_pledged_usd"] as? Double)
    XCTAssertEqual(3_000, props?["project_goal_usd"] as? Double)

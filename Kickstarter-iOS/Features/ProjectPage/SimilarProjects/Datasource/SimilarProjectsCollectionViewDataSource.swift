...
final class SimilarProjectsCollectionViewDataSource: ValueCellDataSource {
  ...
  func load(_ values: [any ProjectCardProperties], isLoading: Bool = false) {
  ...
  override func configureCell(collectionCell cell: UICollectionViewCell, withValue value: Any) {
    ...
    case let (cell as SimilarProjectsCollectionViewCell, value as any ProjectCardProperties):
      cell.configureWith(value: value)
      cell.delegate = self
    default:

...
final class NoShippingConfirmDetailsViewController: UIViewController, MessageBannerViewControllerPresenting {
  // MARK: - Properties
  ...
  private lazy var keyboardDimissingTapGestureRecognizer: UITapGestureRecognizer = {
    UITapGestureRecognizer(
      target: self,
      action: #selector(NoShippingConfirmDetailsViewController.dismissKeyboard)
    )
...
extension NoShippingConfirmDetailsViewController: PledgeAmountViewControllerDelegate {

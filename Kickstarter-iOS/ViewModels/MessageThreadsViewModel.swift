...
internal protocol MessageThreadsViewModelInputs {
...
internal protocol MessageThreadsViewModelOutputs {
...
internal protocol MessageThreadsViewModelType {
  var inputs: MessageThreadsViewModelInputs { get }
  var outputs: MessageThreadsViewModelOutputs { get }
}

internal final class MessageThreadsViewModel: MessageThreadsViewModelType, MessageThreadsViewModelInputs,
MessageThreadsViewModelOutputs {
  ...
  internal func mailboxButtonPressed() {
  ...
  internal func switchTo(mailbox mailbox: Mailbox) {
  ...
  internal let loadingFooterIsHidden: Signal<Bool, NoError>
  internal let goToSearch: Signal<(), NoError>
  internal let mailboxName: Signal<String, NoError>
  internal let messageThreads: Signal<[MessageThread], NoError>
  internal let refreshControlEndRefreshing: Signal<(), NoError>
  internal let showMailboxChooserActionSheet: Signal<(), NoError>

  internal var inputs: MessageThreadsViewModelInputs { return self }
  internal var outputs: MessageThreadsViewModelOutputs { return self }
}

...
public enum ProjectRisksHeaderCellStyles {
  public enum Layout {
    public static let insets: CGFloat = Styles.grid(9)
  }
}

final class ProjectRisksHeaderCell: UITableViewCell, ValueCell {
  // MARK: - Properties
  ...
  override func bindStyles() {
    ...
    _ = self
      ...
      .init(
        ...
        left: 0,
        bottom: 0,
        right: self.bounds.size.width + ProjectRisksHeaderCellStyles.Layout.insets
      )

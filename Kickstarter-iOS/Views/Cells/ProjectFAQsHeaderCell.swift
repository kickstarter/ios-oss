...
public enum ProjectFAQsHeaderCellStyles {
  public enum Layout {
    public static let insets: CGFloat = Styles.grid(9)
  }
}

final class ProjectFAQsHeaderCell: UITableViewCell, ValueCell {
  // MARK: - Properties
  ...
  override func bindStyles() {
    ...
    _ = self
      ...
      .init(
        ...
        left: 0,
        bottom: 0,
        right: self.bounds.size.width + ProjectFAQsHeaderCellStyles.Layout.insets
      )

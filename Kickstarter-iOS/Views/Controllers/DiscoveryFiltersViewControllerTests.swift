...
internal final class DiscoveryFiltersViewControllerTests: TestCase {
  ...
  fileprivate static let ceramics = .template
    ...
    <> Category.lens.parent .~ ParentCategory(analyticsName: Category.art.name, id: Category.art.id, name: Category.art.name)
  ...
  fileprivate static let action = .template
    ...
    <> Category.lens.parent .~ ParentCategory(analyticsName: Category.filmAndVideo.name, id: Category.filmAndVideo.id, name: Category.filmAndVideo.name)
  ...
  fileprivate static let mobileGames = .template
    ...
    <> Category.lens.parent .~ ParentCategory(analyticsName: Category.games.name, id: Category.games.id, name: Category.games.name)

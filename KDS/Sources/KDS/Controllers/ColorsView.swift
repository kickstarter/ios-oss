...
public struct ColorsView: View {
  fileprivate let semanticColors = [
    ...
    Colors.Background.Accent.Blue.disabled,
    Colors.Background.Accent.Blue.subtle,
    Colors.Background.Accent.Green.bold,
    Colors.Background.Accent.Green.Bold.pressed,
    Colors.Background.Accent.Green.disabled,
    Colors.Background.Accent.Green.subtle,
    Colors.Background.Accent.Gray.bold,
    Colors.Background.Accent.Gray.disabled,
    Colors.Background.Accent.Gray.subtle,
    Colors.Background.Accent.Purple.disabled,
    Colors.Background.Accent.Purple.subtle,
    ...
    Colors.Background.Warning.subtle,
    ...
    Colors.Background.Surface.inverse,
    Colors.Background.Surface.raised,
    Colors.Background.Surface.raisedHigher,
    Colors.Background.Surface.overlay,
    Colors.Brand.logo,
